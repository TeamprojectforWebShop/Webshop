		...
		<table>
			<tbody>
				<tr class="dot_line">
					...
					<td>
						<input name="id" id="id" type="text" size="20" value="${list.id}"  readonly/>
					</td>
					 <td>
					</td>
				</tr>
				<tr class="dot_line">
					...
					<td>
					  <input name="pwd" id="pwd" type="password" size="20" value="${list.pwd}" />
					</td>
				</tr>
				<tr class="dot_line">
				...
				<tr class="dot_line">
					...
					<td>
					   <input type="text" id="email" name="email" size=20 value="${list.email}" />
					</td>
					
				<tr class="dot_line">
					<td class="fixed_join">유저등급</td>
					<td>
						<input type="text" id="custRank" name="custRank" size="20" value="${list.joinDate}"/>
					</td>
					 <td>
					</td>
				</tr>
...
//본 예제에서는 도로명 주소 표기 방식에 대한 법령에 따라, 내려오는 데이터를 조합하여 올바른 주소를 구성하는 방법을 설명합니다.
    ...
    $('#modUserButton').click(function(){
    	...
    	let data = $('form[name=frm_mod_user]').serializeObject();
