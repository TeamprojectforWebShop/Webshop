         ...
         <div>
            ...
            <FORM name="" method="post" onsubmit="return validate();"
             ...
             <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="date" class="form-control" name="birth" id="birth" placeholder="ex)19930521" required>
                </div>
             </div>
               <div class="form-group">
                  <div class="col-sm-2 control-label">
                  ...
                  <div class="col-sm-6">
                     <input type="text" class="form-control" name="contact"
                        id="contact" placeholder="-없이 입력해주세요" required>
                  </div>
               </div>
               <div class="form-group">
                  <div class="col-sm-2 control-label">
                  ...
                  <div class="col-sm-3">
                     <input type="text" id="postcode" placeholder="우편번호" name="addr4"
                        class="form-control" placeholder="06267" requried>
                  </div>
                  <div class="col-sm-3">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-6">
                     <input type="text" id="addr" placeholder="도로명주소" name="addr"
                        class="form-control" placeholder="256-32" requried>
                  </div>
               </div>
               <div class="form-group">
                  <div class="col-sm-2 control-label">
                  ...
                  <div class="col-sm-6">
                     <input type="text" id="addr3" placeholder="지번주소" name="addr3"
                        class="form-control" placeholder="256-32" required>
                  </div>
               </div>
               <div class="form-group">
                  <div class="col-sm-2 control-label">
